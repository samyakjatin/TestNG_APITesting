...
public class UserControllerMerged extends BaseTest {
	@Test
    public void Test01GetUserSummary() {
...
String token = Constant.authToken;
   ...
   // request.pathParam("auctionId", auctionId);
    ...
    // Send the GET request with query parameters
    Response response = request.get("/api/v1/user/account-summary/{userId}/{auctionId}"); 
...
@Test
public void Test03GetUserAccountSummary() {
