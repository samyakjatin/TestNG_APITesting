...
public class ClarityController extends BaseTest {
	@Test
	public void test01PutClarityId() {
	...
	public void test02PostClarity() {
		...
		String uniqueName = "harshi" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMddHHmmss"));
	...
	@Test
	public void test03PostClarityExcel() {
		...
		File file = new File("C:\\Users\\ESAMYAK121\\Desktop\\Testing\\clarity_Masters_Excel.xlsx"); // Update with
																									// actual file path
	...
	@Test
	public void test04GetClarities() {
