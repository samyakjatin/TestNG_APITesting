...
public class CutController extends BaseTest {

	@Test
	public void test01PutCutId() {
...
public void test02PostCut() {
	...
	public void test03PostCutExcel() {
		...
		File file = new File("C:\\Users\\ESAMYAK121\\Desktop\\Testing\\cut_Masters_Excel.xlsx"); // Update with actual
																									// file path
